...
import { StyleSheet, Text, View, Platform, TouchableOpacity, AsyncStorage } from 'react-native';
...
export default class App extends React.Component {
  ...
  async componentDidMount() {
    const repos = JSON.parse(await AsyncStorage.getItem('@Minicurso:repo')) || [];
  ...
  _addRepository = async (newRepoText) => {
    ...
    await AsyncStorage.setItem('@Minicurso:repo', JSON.stringify(this.state.repos))
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={() => { this.setState({ modalVisible: true }) }}>
            <Text style={styles.headerButtom}>+</Text>
          </TouchableOpacity>
        </View>
